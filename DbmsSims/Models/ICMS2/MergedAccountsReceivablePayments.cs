namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_ACCOUNTS_RECEIVABLE_PAYMENTS")]
    public partial class MergedAccountsReceivablePayments
    {
        [Key]
        public int merged_accounts_receivable_payments_id { get; set; }
