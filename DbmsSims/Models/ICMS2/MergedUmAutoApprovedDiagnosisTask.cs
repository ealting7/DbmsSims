namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_UM_AUTO_APPROVED_DIAGNOSIS_TASK")]
    public partial class MergedUmAutoApprovedDiagnosisTask
    {
        [Key]
        public int merged_um_auto_approved_diagnosis_task_id { get; set; }

        public int? um_auto_approved_diagnosis_task_id { get; set; }
