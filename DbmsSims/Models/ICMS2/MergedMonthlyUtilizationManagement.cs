namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_MONTHLY_UTILIZATION_MANAGEMENT")]
    public partial class MergedMonthlyUtilizationManagement
    {
        [Key]
        public int merged_monthly_utilization_management_id { get; set; }
