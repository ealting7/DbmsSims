namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_LCM_REPORT_NEEDED_FOR_BILLING_TASK")]
    public partial class MergedLcmReportNeededForBillingTask
    {
        [Key]
        public int merged_lcm_report_needed_for_billing_task_id { get; set; }
