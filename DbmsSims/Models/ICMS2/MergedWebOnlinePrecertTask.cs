namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_WEB_ONLINE_PRECERT_TASK")]
    public partial class MergedWebOnlinePrecertTask
    {
        [Key]
        public int merged_web_online_precert_task_id { get; set; }

        public int? web_online_precert_id { get; set; }
