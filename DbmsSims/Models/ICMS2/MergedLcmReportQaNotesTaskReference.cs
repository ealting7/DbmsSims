namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_LCM_REPORT_QA_NOTES_TASK_REFERENCE")]
    public partial class MergedLcmReportQaNotesTaskReference
    {
        [Key]
        public int merged_lcm_report_qa_notes_task_reference_id { get; set; }
