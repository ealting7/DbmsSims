namespace DbmsSims.Models.ICMS2
{
    ...
    [Table("MERGED_MEMBER_HEALTH_PLAN_REFERENCE")]
    public partial class MergedMemberHealthPlanReference
    {
        [Key]
        public int merged_member_health_plan_reference_id { get; set; }
